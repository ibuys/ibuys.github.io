---
layout: post
title: Why I'm Still Using macOS
date: 2025-11-13 07:00:42
---

I started an email thread with [Jeremy Friesen][1], that we later roped [Jack Baty][2] into, discussing our relative computing choices. The thread has gotten lengthy, and honestly was probably always better suited for blogging, so I decided to post my next response here.

Jeremy and Jack have both switched at least part of their computing from macOS to Linux, continuing a [decades-old][3] [tradition][4] of getting fed up with Apple's corporate malarkey and jumping ship to the open waters of open source. I don't want to speak for them, but my impression is that Jeremy has had more luck making the switch than Jack has, but they've both wound up with one foot in each pool. I feel the pull of [Switcher Season][5] every few years myself, more powerfully in 2025 than in the past, but still not quite strongly enough to convince me that it'd be in my best interest. 
...
[2]: https://baty.net/
[3]: https://daringfireball.net/2006/06/and_oranges
[4]: https://www.tbray.org/ongoing/When/200x/2006/06/15/Switch-From-Mac
[5]: https://jonathanbuys.com/Switcher_Season_2021/
[6]: https://www.garmin.com/en-US/p/1228429/
